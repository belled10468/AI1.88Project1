...
class CornerHeuristicSanity(testClasses.TestCase):
    ...
    def execute(self, grades, moduleDict, solutionDict):
        ...
        for succ in succs:
            ...
            if h0 - h1 > 1:
                print start_state, succ[0], h0 , h1
...
class CornerHeuristicPacman(testClasses.TestCase):
    ...
    def execute(self, grades, moduleDict, solutionDict):
        ...
        solutionDictPath = solutionDict['path'].replace("\n", " ").split(" ")
        print solutionDictPath
        #print [(solutionDictPath[idx], path[idx], solutionDictPath[idx] == path[idx]) for idx in range(len(path)) if idx < len(solutionDictPath)]
